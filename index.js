...
import { ProductDecorator ,GiftWrapDecorator, ExtendedWarrantyDecorator, BaseProduct } from './patterns/structural/ProductDecorator.js';
...
const packageDetails = { weight: 2.5, dimensions: { width: 10, heights: 8, depth: 3 } };
...
const newLaptop = factory.createProduct('electronic', {id: 5, model: 'MacBook Pro', price: 2500 });
